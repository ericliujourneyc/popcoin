...
namespace Checkpoints
{
    ...
    // popcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // popcoin: get last synchronized checkpoint
    ...
    // popcoin: only descendant of current sync-checkpoint is allowed
    ...
    // popcoin: reset synchronized checkpoint to last hardened checkpoint
...
// popcoin: sync-checkpoint master key
...
// popcoin: verify signature of sync-checkpoint message
...
// popcoin: process synchronized checkpoint
