...
// Popcoin message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xae, 0xb5, 0xb9 };
static unsigned char pchMessageStartPopcoin[4] = { 0xb6, 0xa8, 0xd9, 0xf5 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartPopcoin : pchMessageStartBitcoin, sizeof(pchMessageStartPopcoin));
}
