...
static const int COINBASE_MATURITY_POP = 100;
...
static const int LAST_POW_BLOCK = 10000; // Last POW Distribution before going Full POS
#ifdef USE_UPNP
...
static const uint256 hashGenesisBlockOfficial("0x000003a25b806c42ea6110f431322ee608a7e47f192aeb0efde074c06b2d21a7");
static const uint256 hashGenesisBlockTestNet( "0x00000d584f832e72f8be6acbc00c556d041bb395baa19f3ea7a49bc44182bcce");
...
public:
    ...
    {
        // popcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // popcoin: get transaction coin age
...
public:
    ...
    // popcoin: block signature - signed by coin base txout[0]'s owner
    ...
    // popcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // popcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // popcoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // popcoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // popcoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // popcoin: block index flags
    enum  
    {
