 ...
 * The Popcoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Popcoin (Popcoin) Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/popcoin"));
#else
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/popcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/popcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    notificator = new Notificator(tr("popcoin-qt"), trayIcon);
}
